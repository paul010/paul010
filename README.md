...
<table>
  <tr>
    <td width="42%" align="center">
      <img src="assets/dalei-broll/final-still.png" alt="确认后的半调纸拼贴静帧">
...
<img src="assets/dalei-broll/assembly-contact-sheet.jpg" width="100%" alt="Dalei B-roll 从空色场到完整拥抱构图的逐秒组装过程">

### QA is part of the creative work

生成不是终点。我检查真实首帧、逐秒动作、音轨、分辨率，以及确认静帧和视频末帧是否一致。

<img src="assets/dalei-broll/end-frame-comparison.jpg" width="100%" alt="确认静帧与视频最终帧对照">
